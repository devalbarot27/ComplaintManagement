...
const mdPath = path.join(__dirname, 'LLD_LR_Details_Module.md');
const outPath = path.join(__dirname, 'LLD_LR_Details_Module.docx');
const diagramsDir = path.join(__dirname, 'diagrams_lr_details');

const titles = [
  'Figure 1 — High-level architecture',
  'Figure 2 — Entity relationship diagram',
  'Figure 3 — List load database flow',
  'Figure 4 — Sibling Despatch lr_details path',
  'Figure 5 — Sequence: List DataTables',
  'Figure 6 — Sequence: Open AO link',
...
const doc = new Document({
  ...
  title: 'LLD — LR Details Module',
  description: 'Low-Level Design for LR Details Module',
  sections: [
    {
