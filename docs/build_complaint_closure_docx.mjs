...
const mdPath = path.join(__dirname, 'LLD_Complaint_Closure_Flow.md');
const outPath = path.join(__dirname, 'LLD_Complaint_Closure_Flow.docx');
const diagramsDir = path.join(__dirname, 'diagrams_complaint_closure');
...
const doc = new Document({
  ...
  title: 'LLD â€” Complaint Closure Flow',
  description: 'Low-Level Design for Complaint Closure Flow',
  sections: [
    {
