...
const mdPath = path.join(__dirname, 'LLD_Reason_Module.md');
const outPath = path.join(__dirname, 'LLD_Reason_Module.docx');
const diagramsDir = path.join(__dirname, 'diagrams_reason');

const titles = [
  'Figure 1 — High-level architecture',
  'Figure 2 — Entity relationship diagram',
  'Figure 3 — Denormalized name link to Spare Parts items',
  'Figure 4 — Create database flow',
  'Figure 5 — Sequence: Create reason',
  'Figure 6 — Sequence: Soft-delete and Spare Parts impact',
...
const doc = new Document({
  ...
  title: 'LLD — Reason Module',
  description: 'Low-Level Design for Reason Module',
  sections: [
    {
