...
const mdPath = path.join(__dirname, 'LLD_Complaint_Category_Module.md');
const outPath = path.join(__dirname, 'LLD_Complaint_Category_Module.docx');
const diagramsDir = path.join(__dirname, 'diagrams_complaint_category');

const titles = [
  'Figure 1 — High-level architecture',
  'Figure 2 — Entity relationship diagram',
  'Figure 3 — Create database flow',
  'Figure 4 — Sequence: Create category',
  'Figure 5 — Sequence: Soft-delete and Entry impact',
...
const doc = new Document({
  ...
  title: 'LLD — Complaint Category Module',
  description: 'Low-Level Design for Complaint Category Module',
  sections: [
    {
