...
const mdPath = path.join(__dirname, 'LLD_Warranty_Chargeable_Module.md');
const outPath = path.join(__dirname, 'LLD_Warranty_Chargeable_Module.docx');
const diagramsDir = path.join(__dirname, 'diagrams_warranty_chargeable');

const titles = [
  'Figure 1 — High-level architecture',
  'Figure 2 — Entity relationship diagram',
  'Figure 3 — Denormalized name link to Service Log / Spare Parts',
  'Figure 4 — Create database flow',
  'Figure 5 — Sequence: Create warranty / chargeable type',
  'Figure 6 — Sequence: Soft-delete and consumer impact',
...
const doc = new Document({
  ...
  title: 'LLD — Warranty Chargeable Module',
  description: 'Low-Level Design for Warranty Chargeable Module',
  sections: [
    {
