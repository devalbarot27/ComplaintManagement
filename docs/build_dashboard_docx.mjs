...
const mdPath = path.join(__dirname, 'LLD_Dashboard_Module.md');
const outPath = path.join(__dirname, 'LLD_Dashboard_Module.docx');
const diagramsDir = path.join(__dirname, 'diagrams_dashboard');

const titles = [
  'Figure 1 — High-level architecture',
  'Figure 2 — Entity relationship diagram',
  'Figure 3 — KPI load database flow',
  'Figure 4 — Sequence: Page load',
  'Figure 5 — Sequence: Recent Orders AJAX',
...
const doc = new Document({
  ...
  title: 'LLD — Dashboard Module',
  description: 'Low-Level Design for Dashboard Module',
  sections: [
    {
