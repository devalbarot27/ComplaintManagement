...
const mdPath = path.join(__dirname, 'LLD_Part_Replaced_Module.md');
const outPath = path.join(__dirname, 'LLD_Part_Replaced_Module.docx');
const diagramsDir = path.join(__dirname, 'diagrams_part_replaced');

const titles = [
  'Figure 1 — High-level architecture',
  'Figure 2 — Entity relationship diagram',
  'Figure 3 — Denormalized name link to Service Log',
  'Figure 4 — Create database flow',
  'Figure 5 — Sequence: Create part replaced option',
  'Figure 6 — Sequence: Soft-delete and Service Log impact',
...
const doc = new Document({
  ...
  title: 'LLD — Part Replaced Module',
  description: 'Low-Level Design for Part Replaced Module',
  sections: [
    {
