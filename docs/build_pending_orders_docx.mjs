...
const mdPath = path.join(__dirname, 'LLD_Pending_Orders_Module.md');
const outPath = path.join(__dirname, 'LLD_Pending_Orders_Module.docx');
const diagramsDir = path.join(__dirname, 'diagrams_pending_orders');

const titles = [
  'Figure 1 — High-level architecture',
  'Figure 2 — Entity relationship diagram',
  'Figure 3 — Live list load database flow',
  'Figure 4 — Alternate header load database flow',
  'Figure 5 — Sequence: Live list DataTables',
...
const doc = new Document({
  ...
  title: 'LLD — Pending Orders Module',
  description: 'Low-Level Design for Pending Orders Module',
  sections: [
    {
