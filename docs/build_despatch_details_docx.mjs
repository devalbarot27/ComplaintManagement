...
const mdPath = path.join(__dirname, 'LLD_Despatch_Details_Module.md');
const outPath = path.join(__dirname, 'LLD_Despatch_Details_Module.docx');
const diagramsDir = path.join(__dirname, 'diagrams_despatch_details');

const titles = [
  'Figure 1 — High-level architecture',
  'Figure 2 — Entity relationship diagram',
  'Figure 3 — List load database flow',
  'Figure 4 — Cross-module Despatched status use',
  'Figure 5 — Sequence: List DataTables',
  'Figure 6 — Sequence: Open action link',
...
const doc = new Document({
  ...
  title: 'LLD — Despatch Details Module',
  description: 'Low-Level Design for Despatch Details Module',
  sections: [
    {
