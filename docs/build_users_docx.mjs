...
const mdPath = path.join(__dirname, 'LLD_Users_Module.md');
const outPath = path.join(__dirname, 'LLD_Users_Module.docx');
const diagramsDir = path.join(__dirname, 'diagrams_users');
...
const doc = new Document({
  ...
  title: 'LLD â€” Users Module',
  description: 'Low-Level Design for Users Module',
  sections: [
    {
