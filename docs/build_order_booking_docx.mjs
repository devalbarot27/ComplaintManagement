...
const mdPath = path.join(__dirname, 'LLD_Order_Booking_Module.md');
const outPath = path.join(__dirname, 'LLD_Order_Booking_Module.docx');
const diagramsDir = path.join(__dirname, 'diagrams_order_booking');

const titles = [
  'Figure 1 — High-level architecture',
  'Figure 2 — Entity relationship diagram',
  'Figure 3 — Cart to booked lines flow',
  'Figure 4 — API router request / response flow',
  'Figure 5 — Sequence: Cart build API chain',
  'Figure 6 — Live submitCartApi + response flow',
  'Figure 7 — Submit database flow',
  'Figure 8 — Sequence: Add to cart',
  'Figure 9 — Sequence: Submit via API',
  'Figure 10 — Activity diagram',
  'Figure 11 — Class / module diagram',
];
...
const doc = new Document({
  ...
  title: 'LLD — Order Booking Module',
  description: 'Low-Level Design for Order Booking Module',
  sections: [
    {
