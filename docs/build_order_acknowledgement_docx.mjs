...
const mdPath = path.join(__dirname, 'LLD_Order_Acknowledgement_Module.md');
const outPath = path.join(__dirname, 'LLD_Order_Acknowledgement_Module.docx');
const diagramsDir = path.join(__dirname, 'diagrams_order_acknowledgement');

const titles = [
  'Figure 1 — High-level architecture',
  'Figure 2 — Entity relationship diagram',
  'Figure 3 — List load database flow',
  'Figure 4 — Detail load database flow',
  'Figure 5 — Sequence: List DataTables',
  'Figure 6 — Sequence: Open detail',
...
const doc = new Document({
  ...
  title: 'LLD — Order Acknowledgement Module',
  description: 'Low-Level Design for Order Acknowledgement Module',
  sections: [
    {
