...
const mdPath = path.join(__dirname, 'LLD_Assigned_Complaint_List_Module.md');
const outPath = path.join(__dirname, 'LLD_Assigned_Complaint_List_Module.docx');
const diagramsDir = path.join(__dirname, 'diagrams_assigned_list');
...
const doc = new Document({
  ...
  title: 'LLD â€” Assigned Complaint List Module',
  description: 'Low-Level Design for Assigned Complaint List Module',
  sections: [
    {
