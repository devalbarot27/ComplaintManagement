...
const mdPath = path.join(__dirname, 'LLD_Auth_Module.md');
const outPath = path.join(__dirname, 'LLD_Auth_Module.docx');
const diagramsDir = path.join(__dirname, 'diagrams_auth');
...
const doc = new Document({
  ...
  title: 'LLD â€” Auth Module',
  description: 'Low-Level Design for Auth Module',
  sections: [
    {
