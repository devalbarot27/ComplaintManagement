...
const mdPath = path.join(__dirname, 'LLD_Service_Log_Capture_Module.md');
const outPath = path.join(__dirname, 'LLD_Service_Log_Capture_Module.docx');
const diagramsDir = path.join(__dirname, 'diagrams_service_log');

const titles = [
  'Figure 1 — High-level architecture',
  'Figure 2 — Entity relationship diagram',
  'Figure 3 — Create database flow',
  'Figure 4 — Sequence: Create / update service log',
  'Figure 5 — Sequence: Add Spare Parts from Service Log',
...
const doc = new Document({
  ...
  title: 'LLD — Service Log Capture Module',
  description: 'Low-Level Design for Service Log Capture Module',
  sections: [
    {
