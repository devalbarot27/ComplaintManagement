...
const mdPath = path.join(__dirname, 'LLD_Complaint_Entry_Module.md');
const outPath = path.join(__dirname, 'LLD_Complaint_Entry_Module.docx');
const diagramsDir = path.join(__dirname, 'diagrams_complaint_entry');
...
const doc = new Document({
  ...
  title: 'LLD â€” Complaint Entry Module',
  description: 'Low-Level Design for Complaint Entry Module',
  sections: [
    {
