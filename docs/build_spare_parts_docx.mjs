...
const mdPath = path.join(__dirname, 'LLD_Spare_Parts_Consumption_Module.md');
const outPath = path.join(__dirname, 'LLD_Spare_Parts_Consumption_Module.docx');
const diagramsDir = path.join(__dirname, 'diagrams_spare_parts');

const titles = [
  'Figure 1 — High-level architecture',
  'Figure 2 — Entity relationship diagram',
  'Figure 3 — Create database flow',
  'Figure 4 — Sequence: Create / update on Spare Parts page',
  'Figure 5 — Sequence: Add Spare Parts from IB / SL row',
...
const doc = new Document({
  ...
  title: 'LLD — Spare Parts Consumption Module',
  description: 'Low-Level Design for Spare Parts Consumption Module',
  sections: [
    {
