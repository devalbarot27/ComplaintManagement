...
const mdPath = path.join(__dirname, 'LLD_Recent_Orders_Module.md');
const outPath = path.join(__dirname, 'LLD_Recent_Orders_Module.docx');
const diagramsDir = path.join(__dirname, 'diagrams_recent_orders');

const titles = [
  'Figure 1 — High-level architecture',
  'Figure 2 — Entity relationship diagram',
  'Figure 3 — List load database flow',
  'Figure 4 — Re-Push database flow',
  'Figure 5 — Sequence: List and booking deep-link',
  'Figure 6 — Sequence: Re-Push',
...
const doc = new Document({
  ...
  title: 'LLD — Recent Orders Module',
  description: 'Low-Level Design for Recent Orders Module',
  sections: [
    {
