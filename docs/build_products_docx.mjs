...
const mdPath = path.join(__dirname, 'LLD_Products_Module.md');
const outPath = path.join(__dirname, 'LLD_Products_Module.docx');
const diagramsDir = path.join(__dirname, 'diagrams_products');

const titles = [
  'Figure 1 — High-level architecture',
  'Figure 2 — Entity relationship diagram',
  'Figure 3 — Consumer relationships',
  'Figure 4 — Create database flow',
  'Figure 5 — Sequence: Create product',
  'Figure 6 — Sequence: Edit product',
...
const doc = new Document({
  ...
  title: 'LLD — Products Module',
  description: 'Low-Level Design for Products Module',
  sections: [
    {
