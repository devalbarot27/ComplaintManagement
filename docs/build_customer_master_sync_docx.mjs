...
const mdPath = path.join(__dirname, 'LLD_Customer_Master_Sync_Module.md');
const outPath = path.join(__dirname, 'LLD_Customer_Master_Sync_Module.docx');
const diagramsDir = path.join(__dirname, 'diagrams_customer_master_sync');
...
const doc = new Document({
  ...
  title: 'LLD — Customer Master Sync Module',
  description: 'Low-Level Design for Customer Master Sync Module',
  sections: [
    {
