...
<body>
    <div class="main-wrapper" id="mainWrapper">
        ...
        <div class="content">
            ...
            if ((int) ($record['order_type'] ?? 0) !== 2) {
                record_details_field('Level 1 Approval Price', product_format_cos($record['level_1_approval_price'] ?? ''), 'col-md-3');
                record_details_field('Level 2 Approval Price', product_format_cos($record['level_2_approval_price'] ?? ''), 'col-md-3');
            }
            ...
            record_details_field('Updated By', product_display_value(product_updated_by_display_name($obconn, $record['updated_by'] ?? '')), 'col-md-6');
