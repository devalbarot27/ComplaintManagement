...
$showApproval = !empty($header['show_approval']);
$showL1Approval = !empty($header['show_l1_approval']);
$showL2Approval = !empty($header['show_l2_approval']);
$l1Rejected = (($header['l1_status'] ?? '') === 'Rejected');
$l2Rejected = (($header['l2_status'] ?? '') === 'Rejected');
                                ...
                                <div class="oad-address-card">
                                    ...
                                    <div class="oad-address-card__body oad-address-card__body--meta">
                                        <div class="oad-approval-fields">
                                            <div>
                                                <span class="oad-meta-label">Status</span>
                                                <div class="oad-meta-value"><span class="oad-chip"><?php echo $safe['l1_status']; ?></span></div>
                                            </div>
                                            <div>
                                                <span class="oad-meta-label"><?php echo $l1Rejected ? 'Rejected By' : 'Approved By'; ?></span>
                                                <div class="oad-meta-value"><?php echo $safe['l1_approved_by']; ?></div>
                                            </div>
                                            <div>
                                                <span class="oad-meta-label"><?php echo $l1Rejected ? 'Rejected At' : 'Approval At'; ?></span>
                                                <div class="oad-meta-value"><?php echo $safe['l1_approved_at']; ?></div>
                                            </div>
                                            <div class="oad-approval-fields__full">
                                                <span class="oad-meta-label">Remark</span>
                                                <div class="oad-meta-value"><?php echo $safe['l1_remarks']; ?></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <?php } ?>
                                <?php if ($showL2Approval) { ?>
                                <div class="oad-address-card">
                                    <div class="oad-address-card__head">
                                    ...
                                    <div class="oad-address-card__body oad-address-card__body--meta">
                                        <div class="oad-approval-fields">
                                            <div>
                                                <span class="oad-meta-label">Status</span>
                                                <div class="oad-meta-value"><span class="oad-chip"><?php echo $safe['l2_status']; ?></span></div>
                                            </div>
                                            <div>
                                                <span class="oad-meta-label"><?php echo $l2Rejected ? 'Rejected By' : 'Approved By'; ?></span>
                                                <div class="oad-meta-value"><?php echo $safe['l2_approved_by']; ?></div>
                                            </div>
                                            <div>
                                                <span class="oad-meta-label"><?php echo $l2Rejected ? 'Rejected At' : 'Approval At'; ?></span>
                                                <div class="oad-meta-value"><?php echo $safe['l2_approved_at']; ?></div>
                                            </div>
                                            <div class="oad-approval-fields__full">
                                                <span class="oad-meta-label">Remark</span>
                                                <div class="oad-meta-value"><?php echo $safe['l2_remarks']; ?></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
