...
$engineers = service_log_engineers();
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit_service_log'])) {
    ...
    $installedBase = $installedBaseId > 0
        ? service_log_get_installed_base($obconn, $installedBaseId)
        : null;
                        ...
                        <section class="complaint-form-section">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-3 form-group">
                                    ...
                                    <input type="text" class="form-control address-auto-field" name="serial_number" readonly>
                                ...
                                <div class="col-md-4 form-group">
                                    ...
                                    <input type="text" class="form-control address-auto-field" name="machine_model" readonly>
                                ...
                                <div class="col-md-4 form-group">
                                    ...
                                    <select class="form-select" name="warranty_chargeable">
                        ...
                        <section class="complaint-form-section">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-4 form-group">
                                    ...
                                    <select class="form-select" name="engineer_name">
                                        <option value="">Select engineer</option>
                                        <?php foreach ($engineers as $engineer) { ?>
                                        <option value="<?php echo htmlspecialchars($engineer); ?>"><?php echo htmlspecialchars($engineer); ?></option>
                                        <?php } ?>
                                    </select>
                        ...
                        <section class="complaint-form-section">
                            ...
                            <div class="row g-3">
                                <div class="col-md-3 form-group">
                                    ...
                                    <select class="form-select" name="part_replaced">
                                ...
                                <div class="col-md-3 form-group">
                                    ...
                                    <select class="form-select" name="customer_feedback">
