                        ...
                        <section class="complaint-form-section">
                            <div class="complaint-form-section__head">
                                ...
                                <div>
                                    ...
                                    <p class="complaint-form-section__hint">Order details auto-fetch invoice date from system</p>
                                </div>
                            </div>
                            <div class="row g-3">
                                ...
                                <div class="col-md-4 form-group">
                                    ...
                                    <input type="date" class="form-control address-auto-field" name="invoice_date" readonly>
                        ...
                        <section class="complaint-form-section">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12 form-group">
                                    ...
                                    <div class="text-danger validation-msg" data-field="address"></div>
                                </div>
                                <div class="col-md-6 form-group">
                                    <label class="form-label">
                        ...
                        <section class="complaint-form-section">
                            ...
                            <div class="row g-3">
                                <div class="col-md-6 form-group">
                                    ...
                                    <select class="form-select" name="industry_segment">
