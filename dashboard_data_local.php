...
//Static data
$created_orders_count = 12;
$dispatched_orders_count = 23;
$total_orders_count = 63;
//End Static data
...
<div class="content">
    ...
    <div class="alert-grid">
        ...
        <div class="custom-alert alert-orange">
            3 orders pending for more than 10 days
        </div>

        <div class="custom-alert alert-blue">
        ...
        <div class="stat-card">
            ...
            <div class="card-top">
                ...
                <div>
                    ...
                    <?php echo htmlspecialchars((string) $acknowledgementCount); ?>
                    </div>
    ...
    <div class="pipeline-card">
        ...
        <div class="pipeline-header">
            ...
            <div class="pipeline-total">
                Total: <?php echo htmlspecialchars((string) $total_orders_count); ?> orders
            </div>
        ...
        <div class="pipeline-wrapper">
            ...
            <div class="pipeline-step">
                <div class="pipeline-count blue"><?php echo htmlspecialchars((string) $created_orders_count); ?></div>
            ...
            <table class="recent-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="fw-semibold">₹1,25,000</td>
                    ...
                    <tr>
                        ...
                        <td class="fw-semibold">₹3,50,000</td>
                    ...
                    <tr>
                        ...
                        <td class="fw-semibold">₹78,500</td>
                    ...
                    <tr>
                        ...
                        <td class="fw-semibold">₹2,15,000</td>
                    ...
                    <tr>
                        ...
                        <td class="fw-semibold">₹95,200</td>

                        <td>
                            <span class="status-badge acknowledge">
                                Acknowledged
                            </span>
                        </td>
    ...
    new Chart(document.getElementById('statusChart'), {
        ...
        data: {
            ...
            datasets: [{
                ...
                data: [12, <?php echo (int) $acknowledgementCount; ?>, <?php echo (int) $pendingOrdersCount; ?>, 23],
