<?php
/**
 * Complaint Service Log modal (dedicated for complaint module).
 * Expects: $serviceLogWarrantyTypes, $partReplacedOptions
 */
?>
<div class="modal fade" id="installedBaseServiceLogModal" tabindex="-1" aria-hidden="true" data-context="complaint">
        ...
        <div class="modal-content complaint-form-modal">
            <div class="complaint-form-header">
                <div class="complaint-form-header__main">
                    ...
                    <div>
                        <h2 class="complaint-form-header__title" id="ibServiceLogModalTitle">Add Service Log</h2>
                        <p class="complaint-form-header__subtitle" id="ibServiceLogModalSubtitle">
                            Capture service visit details linked to this complaint.
                        </p>
                    </div>
                </div>
            ...
            <form id="installedBaseServiceLogForm" novalidate>
                ...
                <input type="hidden" name="record_id" id="ibServiceLogRecordId" value="">
                <input type="hidden" name="from_complaint_modal" value="1">
                <input type="hidden" name="complaint_id" id="ibServiceLogComplaintId" value="">
                ...
                <div class="complaint-form-body p-4">
                    <section class="complaint-form-section">
                        <div class="complaint-form-section__head">
                            ...
                            <div>
                                <h3 class="complaint-form-section__title">Machine Details</h3>
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-4 form-group">
                                ...
                                <select class="form-control" name="warranty_chargeable" id="ibServiceLogWarrantySelect" data-placeholder="Search complaint category">
                                    <option value=""></option>
                    ...
                    <section class="complaint-form-section">
                        ...
                        <div class="row g-3 align-items-start">
                            <div class="col-md-3 form-group">
                                ...
                                <select class="form-control" name="part_replaced" id="ibServiceLogPartReplacedSelect" data-placeholder="Search part replaced">
                                    <option value=""></option>
                            ...
                            <div id="ibServiceLogPartReplacedCommonHoursWrapper" class="col-md-9 d-none">
                                <div class="row g-3">
                        ...
                        <div id="ibServiceLogPartReplacementWrapper" class="d-none mt-3">
                            <div class="mb-2"><strong>Part Replaced Details</strong></div>
                            <div class="mb-3">
                            ...
                            <div class="row g-3">
                                <div class="col-12 form-group">
                                    <?php service_log_render_customer_feedback_rating_field('ibServiceLog'); ?>
                                </div>
                                <div class="col-12 form-group">
                    ...
                    <section class="complaint-form-section">
                        ...
                        <div class="row g-3">
                            ...
                            ?>
                            <div class="col-md-6 form-group">
                                <label class="form-label"><?php echo htmlspecialchars($consumable['label']); ?> Remaining Date <span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-6 form-group">
                                <label class="form-label"><?php echo htmlspecialchars($consumable['label']); ?> Remaining Hours <span class="text-danger">*</span></label>
                                <input type="number" class="form-control" name="<?php echo htmlspecialchars($hoursField); ?>" min="0" step="0.01">
                ...
                <div class="complaint-form-actions">
                    ...
                    <?php include __DIR__ . '/complaint_service_log_draft_actions.php'; ?>
                    <button class="submit-btn btn-complaint-primary" type="submit" id="submitIbServiceLogBtn">
                        <i class="bi bi-check-lg"></i> <span id="submitIbServiceLogBtnLabel">Submit Service Log</span>
                    </button>
                </div>
            </form>
        </div>
