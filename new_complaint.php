                            ...
                            <div class="row g-3">
                                <div class="col-md-6 form-group">
                                    ...
                                    <select class="form-control" name="complaint_category_id" id="complaintCategorySelect"
                                        data-placeholder="Select call type">
                    ...
                    <div class="complaint-form-body">
                        ...
                        <section class="complaint-form-section d-none" id="closureRemarksWrap">
                            ...
                            <div class="form-group">
                                ...
                                <div class="complaint-closure-rating" id="closureCustomerFeedbackRating">
                                    <input type="hidden" name="customer_feedback" id="closureCustomerFeedbackInput" value="">
                                    ...
                                    <div class="closure-rating__selected" id="closureCustomerFeedbackSelected">No rating selected</div>
                                </div>
...
function initComplaintCategorySelect2() {
    initStaticSelect2('complaintForm', 'complaintCategorySelect', {
        ...
        allowClear: false,
        noResultsText: 'No call type found'
    });
...
function initComplaintEntryDatatable() {
    ...
    if (statusFilter) {
        const rawStatus = String(params.get('status_filter') || '').trim();
        const statusId = rawStatus !== '' && /^\d+$/.test(rawStatus) ? String(parseInt(rawStatus, 10)) : '';
    ...
    const table = $table.DataTable({
        ...
        ajax: {
            ...
            data: function (payload) {
                const filterEl = document.getElementById('complaintHistoryStatusFilter');
                if (filterEl) {
                    payload.status_filter = filterEl.value;
                }
                if (complaintId !== '') {
...
function initClosureValidation() {
    ...
    function toggleClosureFields() {
        ...
        if (!isYes && typeof resetClosureCustomerFeedbackRating === 'function') {
    ...
    function setFieldError(fieldName, message) {
        ...
        if (fieldName === 'customer_feedback') {
            if (typeof setClosureCustomerFeedbackRatingError === 'function') {
                setClosureCustomerFeedbackRatingError(message);
                return;
            }
        }
    ...
    function validateClosureForm() {
        ...
        if (callClosure === 'Yes') {
            ...
            const customerFeedback = typeof getClosureCustomerFeedbackRating === 'function'
                ? getClosureCustomerFeedbackRating()
                : form.querySelector('[name="customer_feedback"]').value.trim();
...
<?php if ($canShowComplaintClosure) { ?>
    ...
    initClosureCustomerFeedbackRating();
<?php if ($canReassignComplaint) { ?>
