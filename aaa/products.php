...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit_product'])) {
    ...
    $isEdit = $recordId > 0;
    $existing = $isEdit ? product_get_by_id($obconn, $recordId) : null;
    $data = product_from_post($_POST, $existing);
        ...
        <div class="content">
                    ...
                    <div class="complaint-form-body">
                        <section class="complaint-form-section">
                            ...
                            <div class="col-md-3 form-group">
                                ...
                                <div class="col-md-3 form-group js-units-approval-price-field">
                                    <label class="form-label">Level 1 Approval Price <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" name="level_1_approval_price" maxlength="20" placeholder="0" inputmode="decimal" autocomplete="off">
                                    <div class="text-danger validation-msg" data-field="level_1_approval_price"></div>
                                </div>
                                <div class="col-md-3 form-group js-units-approval-price-field">
                                    <label class="form-label">Level 2 Approval Price <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" name="level_2_approval_price" maxlength="20" placeholder="0" inputmode="decimal" autocomplete="off">
                                    <div class="text-danger validation-msg" data-field="level_2_approval_price"></div>
                                </div>
            ...
            <div class="booking-card">
                <div class="booking-header d-flex justify-content-between align-items-center flex-wrap gap-2">
                    <div class="booking-title">Product Master List</div>
                    ...
                    <table class="table table-hover booking-table w-100" id="productsTable">
                        <thead>
                            <tr>
                                ...
                                <th>COS (Price)</th>
                                <th>Level 1 Approval Price</th>
                                <th>Level 2 Approval Price</th>
                                <th>Valid</th>
                                <th>Company</th>
                                <th>Warehouse</th>
                                <th>Order Type</th>
